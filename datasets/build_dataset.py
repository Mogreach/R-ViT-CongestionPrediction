...
def build_dataset(opt):
    ...
    if opt['test_mode']:
        return DataLoader(dataset=dataset, num_workers=0, batch_size=1, shuffle=False)
    else:
        return IterLoader(DataLoader(dataset=dataset, num_workers=opt['num_workers'], batch_size=opt['batch_size'], shuffle=True, drop_last=True, pin_memory=True))
